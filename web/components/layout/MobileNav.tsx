...
export function MobileNav() {
  ...
  return (
    <nav
      ...
      className="xl:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-white/20 dark:border-white/12 bg-[#1E3A2B]/92 dark:bg-[#07150E]/90 backdrop-blur-2xl px-2 shadow-[0_-8px_32px_rgba(30,58,43,.25)] dark:shadow-[0_-8px_32px_rgba(0,0,0,0.6)] pb-safe md:bottom-4 md:left-1/2 md:-translate-x-1/2 md:w-auto md:min-w-140 md:max-w-2xl md:rounded-full md:border md:shadow-[0_16px_42px_rgba(30,58,43,.35)] dark:md:shadow-[0_16px_42px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.15)] md:px-3 md:pb-0"
    >
